...
> **Implementations**: `AWSECSService`, `GCPCloudRunJob`, `GCPCloudRunService`, `KubernetesCronJob`, `KubernetesDaemonSet`, `KubernetesDeployment`, `KubernetesJob`, `KubernetesStatefulSet`, `ModalApp`, `NetlifySite`, `RailwayServiceInstance`, `ScalewayServerlessContainer`, `SnowflakeService`.
...
> **Implementations**: `AWSEC2SecurityGroup`, `AzureFirewall`, `AzureNetworkSecurityGroup`, `CloudflareRuleset`, `DatabricksIpAccessList`, `GCPCloudArmorPolicy`, `GCPFirewall`, `ScalewaySecurityGroup`, `SnowflakeNetworkPolicy`, `SnowflakeNetworkRule`.
...
> **Implementations**: `AWSGuardDutyFinding`, `AWSInspectorFinding`, `AzureSecurityAssessment`, `BbotFinding`, `GitHubDependabotAlert`, `SemgrepSASTFinding`, `SemgrepSCAFinding`, `SemgrepSecretsFinding`, `SocketDevAlert`, `SupabaseSecurityAdvisorFinding`, `WizFinding`, `WizIssue`.
